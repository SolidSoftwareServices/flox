...
******************************/
    public partial class RequestChangeFunction : ODataFunction<RequestChangeFunction.QueryObject, AccountContactDto>
    {
        public RequestChangeFunction(params Expression<Func<AccountContactDto, object>>[] expands): base("RequestChange", expands)
        {
        }
