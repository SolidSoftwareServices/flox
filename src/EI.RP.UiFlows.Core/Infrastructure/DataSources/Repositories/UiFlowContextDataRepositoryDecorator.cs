...
namespace EI.RP.UiFlows.Core.Infrastructure.DataSources.Repositories
{
	internal class UiFlowContextDataRepositoryDecorator : IUiFlowContextRepository
	{
		private readonly IInternalUiFlowContextRepository _decoratedRepository;
		...
		public UiFlowContextDataRepositoryDecorator(IInternalUiFlowContextRepository decoratedRepository,
			IProfiler profiler)
		{
