...
{
	internal class MarketingPreferencesWithLoginPageTests : WebAppPageTests<LoginPage>
    {
	    ...
	    public async Task MarketingPageWorkingAsExpected()
	    {
		    ...
		    var accountInfo = _userConfig.ElectricityAndGasAccountConfigurators.Single().Model;
