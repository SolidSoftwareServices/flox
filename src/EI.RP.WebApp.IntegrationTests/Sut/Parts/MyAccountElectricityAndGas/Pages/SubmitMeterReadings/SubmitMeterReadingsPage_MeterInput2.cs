...
{
	internal class SubmitMeterReadingsPage_MeterInput2 : SubmitMeterReadingsPage_MeterInput1
	{
		public SubmitMeterReadingsPage_MeterInput2(ResidentialPortalApp app) : base(app)
		{
		}
