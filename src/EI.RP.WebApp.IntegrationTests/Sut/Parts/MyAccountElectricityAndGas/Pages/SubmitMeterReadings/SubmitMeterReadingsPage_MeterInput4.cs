...
{
	internal class SubmitMeterReadingsPage_MeterInput4 : SubmitMeterReadingsPage_MeterInput1
	{
		public SubmitMeterReadingsPage_MeterInput4(ResidentialPortalApp app) : base(app)
		{
		}
