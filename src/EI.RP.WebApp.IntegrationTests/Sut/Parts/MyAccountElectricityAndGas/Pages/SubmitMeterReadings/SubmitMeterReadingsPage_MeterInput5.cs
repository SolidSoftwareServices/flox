...
{
	internal class SubmitMeterReadingsPage_MeterInput5 : SubmitMeterReadingsPage_MeterInput1
	{
		public SubmitMeterReadingsPage_MeterInput5(ResidentialPortalApp app) : base(app)
		{
		}
