...
{
    [TestFixture]
    class WhenInMovingHomeLandingPageDuelFuelElectricityExitFeeTest : WhenInMovingHomePageTest<Step0LandingPage>
    {
        ...
        {
            var accountInfo = UserConfig.ElectricityAndGasAccountConfigurators.First().Model;
            Assert.IsNotNull(Sut.ExitFeeCloseBothDetail);
            var feeInfoTextCloseBoth = $"PLEASE NOTE: The Electricity Account ({accountInfo.AccountNumber}) is still in contract. By closing this account you will incur an early exit fee of €50. This will be added to your final bill.";
            ...
            var feeInfoTextMoveAndClose = $"PLEASE NOTE: The Electricity Account ({accountInfo.AccountNumber}) is still in contract. By closing this account you will incur an early exit fee of €50. This will be added to your final bill.";
