...
{
	[TestFixture]
	class WhenInMovingHomeStep3PageMoveElectricityAndGas_ElectricityIsNewAcquisitionTest : MyAccountCommonTests<Step3InputMoveInPropertyDetailsPage>
	{
        ...
        protected override async Task TestScenarioArrangement()
		{
			...
			step1Page = (await movingHomeLandingPage.ClickOnElement(movingHomeLandingPage.PopupButton1)).CurrentPageAs<Step1InputMoveOutPage>();
