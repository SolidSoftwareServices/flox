...
{
	[TestFixture]
	internal class WhenInSubmitMeterReading_Electricity_3_Inputs_Tests : WhenInSubmitMeterReadingTests<SubmitMeterReadingsPage_MeterInput3>
	{
        protected override async Task TestScenarioArrangement()
        {
            ...
            Sut = a.CurrentPageAs<SubmitMeterReadingsPage_MeterInput3>();
        }

        [Test]
        public override async Task CanSubmit()
        {
			var inputs = CreateMeterInputs(3);
        ...
        public async Task WhenEmptyShowsError()
        {
			...
			sut = (await sut.ClickOnElement(sut.SubmitButton)).CurrentPageAs<SubmitMeterReadingsPage_MeterInput3>();
