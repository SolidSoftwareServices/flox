...
{
	[TestFixture]
	internal class WhenInSubmitMeterReading_Electricity_5_Inputs_Tests : WhenInSubmitMeterReadingTests<SubmitMeterReadingsPage_MeterInput5>
	{
        protected override async Task TestScenarioArrangement()
        {
            ...
            Sut = a.CurrentPageAs<SubmitMeterReadingsPage_MeterInput5>();
        }

        [Test]
        public override async Task CanSubmit()
        {
			var inputs = CreateMeterInputs(5);
        ...
        public async Task WhenEmptyShowsError()
        {
			...
			sut = (await sut.ClickOnElement(sut.SubmitButton)).CurrentPageAs<SubmitMeterReadingsPage_MeterInput5>();
