...
{
    [TestFixture]
    class WhenInTermsAndConditionsPageTest : MyAccountCommonTests<TermsInfoPage>
    {
        protected override async Task TestScenarioArrangement()
        {
            ...
            app = await app.CurrentPageAs<MyAccountElectricityAndGasPage>().ToTermsAndCondition();
