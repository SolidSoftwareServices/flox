...
{
	public class ChangePasswordFlowInitializer : UiFlowInitializationStep<ResidentialPortalFlowType>
	{
		private readonly IUserSessionProvider _userSessionProvider;


		public ChangePasswordFlowInitializer(IUserSessionProvider userSessionProvider)
		{
			_userSessionProvider = userSessionProvider;
		}

		public override ResidentialPortalFlowType InitializerOfFlowType => ResidentialPortalFlowType.ChangePassword;
			...
			IScreenFlowConfigurator preStartCfg, UiFlowContextData contextData)
		{
			return preStartCfg
				...
				.OnEventNavigatesTo(ScreenEvent.Start, ChangePasswordStep.ChangePassword);
		}
	}
}