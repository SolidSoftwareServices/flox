...
namespace EI.RP.NavigationPrototype.IntegrationTests.Sut.ContainersFlow.Tests.BlueFlow.StepC
{
	[TestFixture]
	internal class WhenMultipleNesting_BlueFlowStepCTests : WhenInContainer_BlueFlowStepATests<Container1Page0>
	{
